        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <Link href="/" className="-m-1.5 p-1.5">
              <span className="font-bold text-xl text-white">SpeechCode</span>
            </Link>
          </div>
          <div className="hidden lg:flex lg:gap-x-12">
            ...
            <Link href="#" className="text-sm font-semibold text-white hover:text-gray-300">Analytics</Link>
            <Link href="#" className="text-sm font-semibold text-white hover:text-gray-300">Company</Link>
          </div>
