        ...
        <section className="max-w-7xl mx-auto p-12 bg-gray-800 text-center rounded-lg shadow-lg">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-700 shadow-lg rounded-lg">
              ...
              <button className="mt-8 w-full px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Get Started</button>
            </div>
            
            <div className="p-6 bg-gray-700 shadow-lg rounded-lg border-2 border-blue-500 transform scale-105">
              <span className="bg-blue-500 text-white px-2 py-1 rounded-full text-xs absolute -top-3 left-1/2 transform -translate-x-1/2">MOST POPULAR</span>
              ...
              <button className="mt-8 w-full px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Start Free Trial</button>
            </div>
            ...
            <div className="p-6 bg-gray-700 shadow-lg rounded-lg">
              ...
              <button className="mt-8 w-full px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Contact Us</button>
            </div>
          </div>
        </section>
      </main>
